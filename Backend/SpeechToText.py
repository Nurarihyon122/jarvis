...
</html>'''# Define the HTML code for the speech recognition interface.
...
def QueryModifier(Query):
    ...
    question_words = ["how", "what", "who", "where", "when", "why", "which", "whōse", "whom" "can you", "what's", "where's", "how's", "can you"]
